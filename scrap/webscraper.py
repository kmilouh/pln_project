...
for language, url in urls.items():
    ...
    sec = SubSecction('FAQ language {0}'.format(language), url, '')
    ...
    for tweet in content.findAll('div', attrs={"class": "hp01__content"}):
        ...
        mainSecction_item = SubSecction(title, url, tweet.p.text.strip())
        ...
        for text in tweet.findAll('li', attrs={"class", "hp01__topic-list-item"}):
            ...
            if text.a.get('href') in url_dictionary:
                ...
                url_dictionary[text.a.get('href')] = 1
            sub_content_secction = SubSecction(sub_content_secction_title,text.a.get('href'), '')
                    ...
                    for item_text in item_list:
                        ...
                        if item_text['url'] in url_dictionary:
                            continue
                             ...
                             url_dictionary[item_text['url']] = 1
                        ...
                        item_subSection = SubSecction(item_text['name'],item_text['url'],buffer)
